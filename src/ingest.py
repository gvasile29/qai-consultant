...
if sys.stdout.encoding and sys.stdout.encoding.lower() != "utf-8":
    sys.stdout.reconfigure(encoding="utf-8")  # type: ignore[union-attr]  # reconfigure() exists on the real TextIOWrapper sys.stdout always is at runtime; mypy's TextIO protocol just doesn't declare it
