...
Covers:
1. version.py is bumped to 2.5.1 / 2026-07-08
...
_EXPECTED_HEADING_SUBSTRINGS = [
    "[2.5.1]", "[2.5.0]", "[2.0.2]", "[2.0.1]", "[2.0.0]", "[1.0.0]",
    "v0.6", "v0.5", "v0.4", "v0.3", "v0.2", "v0.1",
]


def test_version_bumped_to_2_5_1():
    """version.py must be bumped for the audit/evaluation KB expansion ship."""
    assert __version__ == "2.5.1", f"Expected __version__ == '2.5.1', got {__version__!r}"
    assert __release_date__ == "2026-07-08", \
        f"Expected __release_date__ == '2026-07-08', got {__release_date__!r}"
    print("  PASS: version.py bumped to 2.5.1 / 2026-07-08")
